...
ADDITIVE_MIGRATIONS = [
    ...
    "ALTER TABLE stores ADD COLUMN IF NOT EXISTS shop_cipher VARCHAR(255)",
    ...
    "ALTER TABLE stores ADD COLUMN IF NOT EXISTS refresh_token VARCHAR(2048)",
    "ALTER TABLE stores ADD COLUMN IF NOT EXISTS token_expires_at TIMESTAMPTZ",
    "ALTER TABLE stores ADD COLUMN IF NOT EXISTS refresh_token_expires_at TIMESTAMPTZ",
    "ALTER TABLE stores ADD COLUMN IF NOT EXISTS connection_status VARCHAR(32) NOT NULL DEFAULT 'disconnected'",
    "ALTER TABLE stores ADD COLUMN IF NOT EXISTS last_verified_at TIMESTAMPTZ",
    "ALTER TABLE stores ALTER COLUMN access_token TYPE VARCHAR(2048)",
    # MasterSKU
